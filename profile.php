...
?>
  ...
  Password:<br>
  <input type="password" id="password" name="Password" placeholder="<?php echo $password;?>" readonly><br><br>
...
<?php
 echo " <a href=\"profileUpdate.php?id=$_SESSION[ID]\" >";
 ?>
 
 <button type="button" class="UpdateProfileButton">Update Profile</button></a>
